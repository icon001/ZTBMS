...
type
  ...
  private
    ...
    procedure SetHURelayDBConnected(const Value: Boolean);
  public
    { Public declarations }
    ...
    Function HURelayAdoConnect(aDataBaseType,aServerIP,aServerPort,aDataBaseName,aUserID,aUserPw:string):Boolean;
  ...
  public
    ...
    property HURelayDBConnected : Boolean read FHURelayDBConnected write SetHURelayDBConnected;
...
function TdmRelayDB.HURelayAdoConnect(aDataBaseType, aServerIP,
  aServerPort, aDataBaseName, aUserID, aUserPw: string): Boolean;
var
  conStr : string;
begin
  result := False;
  HURelayDBConnected := False;
...
procedure TdmRelayDB.SetHURelayDBConnected(const Value: Boolean);
begin
  FHURelayDBConnected := Value;
end;
