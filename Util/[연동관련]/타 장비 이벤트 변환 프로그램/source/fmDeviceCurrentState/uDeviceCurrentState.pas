...
procedure TfmDeviceCurrentState.AdvStringGrid1Resize(Sender: TObject);
begin
  StringGrideResize(AdvStringGrid1);
end;

procedure TfmDeviceCurrentState.StringGrideDrawCell(Sender: TObject; ACol,
  ARow: Integer; Rect: TRect; State: TGridDrawState);
var
  DataInCell : string;
  nLeft,nTop : integer;
...
procedure TfmDeviceCurrentState.btn_ClearClick(Sender: TObject);
var
  i:integer;
begin
  bClear := True;
...
procedure TfmDeviceCurrentState.btn_FileSaveClick(Sender: TObject);
var
  aFileName: String;
  sDate: String;
  eDate: String;
...
procedure TfmDeviceCurrentState.btn_startClick(Sender: TObject);
begin
  bStart := True;
...
procedure TfmDeviceCurrentState.btn_stopClick(Sender: TObject);
begin
  bStart := False;
...
procedure TfmDeviceCurrentState.SearchTimerTimer(Sender: TObject);
begin
  SearchTimer.Enabled := False;
...
procedure TfmDeviceCurrentState.AdvStringGrid1KeyDown(Sender: TObject;
