    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if FindField('CO_CONFIGCODE').AsString = 'DBTYPE'   then cmb_DBType.itemIndex := strtoint(FindField('CO_CONFIGVALUE').AsString) - 1;
          if FindField('CO_CONFIGCODE').AsString = 'DBIP'     then ed_dbip.Text := FindField('CO_CONFIGVALUE').AsString;
          if FindField('CO_CONFIGCODE').AsString = 'DBPORT'   then ed_dbport.Text := FindField('CO_CONFIGVALUE').AsString;
          if FindField('CO_CONFIGCODE').AsString = 'DBUSERID' then ed_dbuserid.Text := FindField('CO_CONFIGVALUE').AsString;
          if FindField('CO_CONFIGCODE').AsString = 'DBUSERPW' then ed_dbpw.Text := FindField('CO_CONFIGVALUE').AsString;
          if FindField('CO_CONFIGCODE').AsString = 'DBNAME'   then ed_dbname.Text := FindField('CO_CONFIGVALUE').AsString;
          if FindField('CO_CONFIGCODE').AsString = 'RELAYTIME'   then ed_RelayTime.Text := FindField('CO_CONFIGVALUE').AsString;
        end;
        Next;
      end;
    end;
