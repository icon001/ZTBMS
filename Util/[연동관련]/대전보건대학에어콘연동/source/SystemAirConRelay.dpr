...
uses
  ...
  uSysAirconDevice in 'fmSysAirconDevice\uSysAirconDevice.pas' {fmSysAirconDevice},
  uSysAirconDMS in 'fmSysAirconDMS\uSysAirconDMS.pas' {fmSysAirconDMS},
  uSysAirconControler in 'fmSysAirconControler\uSysAirconControler.pas' {fmSysAirconControler},
  uSysAirconRelay in 'fmSysAirconRelay\uSysAirconRelay.pas' {fmSysAirconRelay},
  udmSystemAirCon in '..\lib\udmSystemAirCon.pas' {dmSystemAircon: TDataModule},
