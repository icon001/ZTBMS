...
begin
  ...
  Try
    ...
    TempAdoQuery.Connection := fmMain.ZmosADOConnection;
    ...
    begin
      ...
      Try
        Open;
      Except
        result := fmMain.FillZeroNumber(nSeq,3);
        Exit;
      End;
      ...
      begin
        if fmMain.IsDigit(FindField('DG_CODE').AsString) then
        begin
...
begin
  ...
  result := fmMain.ZmosProcessExecSQL(stSql);
end;
