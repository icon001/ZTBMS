...
uses
  ...
  Dialogs, CommandArray, StdCtrls, RunDLL, Grids,DB,ExtCtrls,Jpeg;
...
type
  ...
  public
    ...
    Procedure RowGridInitialize(sg_Grid:TStringGrid;aRow:integer = 2); //모두 지움 쓰레기 데이터 남을수 없도록
    Procedure GridInitialize(sg_Grid:TStringGrid;aRow:integer = 2);
    procedure GridInit(sg:TStringGrid;aCol:integer;aRow:integer = 2);
...
procedure TfmASubForm.GridInitialize(sg_Grid: TStringGrid;aRow:integer = 2);
var
  i:integer;
begin
  with sg_Grid do
...
procedure TfmASubForm.GridInit(sg: TStringGrid; aCol: integer;aRow:integer = 2);
var
  i:integer;
begin
  with sg do
...
procedure TfmASubForm.RowGridInitialize(sg_Grid: TStringGrid;aRow:integer = 2);
var
  i,j:integer;
begin
  with sg_Grid do
