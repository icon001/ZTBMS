...
uses
  ...
  uDeviceFunctionCode in 'fmDeviceFunctionCode\uDeviceFunctionCode.pas' {fmDeviceFunctionCode},
  ...
  uDeviceModelCode in 'fmDeviceModelCode\uDeviceModelCode.pas' {fmDeviceModelCode},
  uJijumCode in 'fmJijumCode\uJijumCode.pas' {fmJijumCode},
  uProcessTime in 'fmProcessTime\uProcessTime.pas' {fmProcessTime},
  uTelGubunCode in 'fmTelGubunCode\uTelGubunCode.pas' {fmTelGubunCode},
  uDeviceFunctionGroup in 'fmDeviceFunctionGroup\uDeviceFunctionGroup.pas' {fmDeviceFunctionGroup},
  ...
  uControlerInfomation in 'fmControlerInfomation\uControlerInfomation.pas' {fmControlerInfomation},
  ...
  uReSendTelNum in 'fmReSendTelNum\uReSendTelNum.pas' {fmReSendTelNum},
  ...
  uUpdateASList in 'fmUpdateASList\uUpdateASList.pas' {fmUpdateASList},
  uUpdateASGoodsList in 'fmUpdateASGoodsList\uUpdateASGoodsList.pas' {fmUpdateASGoodsList},
  uProductList in 'fmProductList\uProductList.pas' {fmProductList},
  uProductCreateRequest in 'fmProductCreateRequest\uProductCreateRequest.pas' {fmProductCreateRequest},
  uProductSummary in 'fmProductSummary\uProductSummary.pas' {fmProductSummary},
  uConsultCode in 'fmConsultCode\uConsultCode.pas' {fmConsultCode},
  uCompanyCode in 'fmCompanyCode\uCompanyCode.pas' {fmCompanyCode},
  uDeviceName in 'fmDeviceName\uDeviceName.pas' {fmDeviceName},
  uDeviceType in 'fmDeviceType\uDeviceType.pas' {fmDeviceType},
  uErrorTarget in 'fmErrorTarget\uErrorTarget.pas' {fmErrorTarget},
  uErrorList in 'fmErrorList\uErrorList.pas' {fmErrorList},
  uSMSReceiveReport in 'fmSMSReceiveReport\uSMSReceiveReport.pas' {fmSMSReceiveReport},
  uSMSSender in 'fmSMSSender\uSMSSender.pas' {fmSMSSender},
  uReceiveTelNum in 'fmReceiveTelNum\uReceiveTelNum.pas' {fmReceiveTelNum},
  uSMSReceiveMessage in 'fmSMSReceiveReport\uSMSReceiveMessage.pas' {fmSMSReceiveMessage},
