...
begin
  if AttendConfigCodeList.IndexOf(aData) < 0 then AttendConfigCodeList.Add(aData);
end;
...
begin
  if AttendConfigHInFromTimeList.IndexOf(aData) < 0 then AttendConfigHInFromTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigHWorkTimeList_Add(aData: string);
begin
  if AttendConfigHWorkTimeList.IndexOf(aData) < 0 then AttendConfigHWorkTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigSInFromTimeList_Add(aData: string);
begin
  if AttendConfigSInFromTimeList.IndexOf(aData) < 0 then AttendConfigSInFromTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigSWorkTimeList_Add(aData: string);
begin
  if AttendConfigSWorkTimeList.IndexOf(aData) < 0 then AttendConfigSWorkTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigInFromTimeList_Add(aData: string);
begin
  if AttendConfigInFromTimeList.IndexOf(aData) < 0 then AttendConfigInFromTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigWorkTimeList_Add(aData: string);
begin
  if AttendConfigWorkTimeList.IndexOf(aData) < 0 then AttendConfigWorkTimeList.Add(aData);
end;
...
begin
  if AttendConfigHOutTimeList.IndexOf(aData) < 0 then AttendConfigHOutTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigHExtendTimeList_Add(aData: string);
begin
  if AttendConfigHExtendTimeList.IndexOf(aData) < 0 then AttendConfigHExtendTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigHNightTimeList_Add(aData: string);
begin
  if AttendConfigHNightTimeList.IndexOf(aData) < 0 then AttendConfigHNightTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigSOutTimeList_Add(aData: string);
begin
  if AttendConfigSOutTimeList.IndexOf(aData) < 0 then AttendConfigSOutTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigSExtendTimeList_Add(aData: string);
begin
  if AttendConfigSExtendTimeList.IndexOf(aData) < 0 then AttendConfigSExtendTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigSNightTimeList_Add(aData: string);
begin
  if AttendConfigSNightTimeList.IndexOf(aData) < 0 then AttendConfigSNightTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigOutTimeList_Add(aData: string);
begin
  if AttendConfigOutTimeList.IndexOf(aData) < 0 then AttendConfigOutTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigExtendTimeList_Add(aData: string);
begin
  if AttendConfigExtendTimeList.IndexOf(aData) < 0 then AttendConfigExtendTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigNightTimeList_Add(aData: string);
begin
  if AttendConfigNightTimeList.IndexOf(aData) < 0 then AttendConfigNightTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigHInToTimeList_Add(aData: string);
begin
  if AttendConfigHInToTimeList.IndexOf(aData) < 0 then AttendConfigHInToTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigInToTimeList_Add(aData: string);
begin
  if AttendConfigInToTimeList.IndexOf(aData) < 0 then AttendConfigInToTimeList.Add(aData);
end;

procedure TdmAttendEvent.AttendConfigSInToTimeList_Add(aData: string);
begin
  if AttendConfigSInToTimeList.IndexOf(aData) < 0 then AttendConfigSInToTimeList.Add(aData);
end;
