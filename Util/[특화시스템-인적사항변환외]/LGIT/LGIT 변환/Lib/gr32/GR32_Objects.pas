...
type
  ...
  private
    ...
    FObjID: string;
    FAlertColor: TColor32;
    FNormalColor: TColor32;
    FObjName: string;
    FNodeNo: string;
    FFloorCode: string;
    ...
    procedure SetAlertColor(const Value: TColor32);
    procedure SetNormalColor(const Value: TColor32);
    procedure SetObjName(const Value: string);
    procedure SetArearCode(const Value: string);
    ...
    procedure SetNodeNo(const Value: string);
  ...
  published
    ...
    //MapÁ¤º¸
    property MapType:string read FMapType write SetMapType;
    ...
    property ArearCode:string read FArearCode write SetArearCode;
    property NodeNo:string read FNodeNo write SetNodeNo;
    property EcuID:string read FEcuID write SetEcuID;
    property AlertColor: TColor32 read FAlertColor write SetAlertColor default clRed32;
    property NormalColor: TColor32 read FNormalColor write SetNormalColor default clGreen32;
...
procedure TDrawObjLayerBase.SetObjID(const Value: string);
begin
  FObjID := Value;
end;

procedure TDrawObjLayerBase.SetAlertColor(const Value: TColor32);
begin
  FAlertColor := Value;
end;

procedure TDrawObjLayerBase.SetNormalColor(const Value: TColor32);
begin
  FNormalColor := Value;
end;

procedure TDrawObjLayerBase.SetObjName(const Value: string);
begin
  FObjName := Value;
end;

procedure TDrawObjLayerBase.SetArearCode(const Value: string);
begin
  FArearCode := Value;
end;

procedure TDrawObjLayerBase.SetBuildingCode(const Value: string);
begin
  FBuildingCode := Value;
end;

procedure TDrawObjLayerBase.SetEcuID(const Value: string);
begin
  FEcuID := Value;
end;

procedure TDrawObjLayerBase.SetFloorCode(const Value: string);
begin
  FFloorCode := Value;
end;

procedure TDrawObjLayerBase.SetNodeNo(const Value: string);
begin
  FNodeNo := Value;
end;

procedure TDrawObjLayerBase.SetMapType(const Value: string);
begin
  FMapType := Value;
end;
