...
function TFireBird.AlterTB_ALARMEVENTSMSSEND_Add: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMEVENT ADD AL_SMSSEND char(1) DEFAULT ''N'' ';
  result := stSql;
...
function TFireBird.AlterTB_ALARMSTATUSCODESMSSEND_Add: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMSTATUSCODE ADD AL_SMSSEND char(1) ';
  result := stSql;
end;
...
function TFireBird.AlterTB_SMSALARMZONEName_Add: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_SMSALARMZONE ADD SA_NAME varchar(100) ';
  result := stSql;
...
function TFireBird.CreateTB_SMSALARMSTATE: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' SA_NAME varchar(100) ,';
  stSql := stSql + ' SA_USE varchar(1)  ,';
  stSql := stSql + ' SA_MESSAGE varchar(200)  ,';
...
function TFireBird.CreateTB_SMSALARMZONE: string;
var
  stSql : string;
begin
...
function TFireBird.CreateTB_SMSUSER: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' SA_NAME varchar(50) ,';
