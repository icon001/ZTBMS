...
type
  ...
  public
    ...
    function TB_ATEVENTOutTimeUpdate(aDate,aCompanyCode,aEMCode,aNowTime,aAtOutCode:string):Boolean;
...
uses
  uCommonVariable,
  uLomosUtil, uMDBSql, uPostGreSql, uMssql, uDataModule1;
{$R *.dfm}
  ...
  Try
    ...
    begin
      ...
      begin
        case DoorNo of
          '0':begin
              if (FindField('DE_USEALARM').asString = 'Y') and
...
function TdmAdoQuery.TB_ATEVENTOutTimeUpdate(aDate,aCompanyCode,aEMCode,aNowTime,aAtOutCode:string): Boolean;
var
  stSql : string;
begin
