...
uses
  SysUtils, Classes, OoMisc, AdPort, AdWnPort, ExtCtrls,uDataModule1;
...
var
  ...
  stEvent : string;
begin
  if G_stBuildingStep = '0' then stBuildingCode := BuildingCode
  else if G_stBuildingStep = '1' then stBuildingCode := BuildingCode + FloorCode
  else if G_stBuildingStep = '2' then stBuildingCode := BuildingCode + FloorCode + AreaCode;
