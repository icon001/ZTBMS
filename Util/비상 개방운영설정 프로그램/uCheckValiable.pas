...
const
  ...
  MACINFO = 30;
  DOORSTATECHECK = 31;        //출입문상태체크
  DEVICECODECHECK = 32;        //기기코드 조회
  KTTSYSTEMID = 33;           //관제시스템아이디
  KTTTELNUM = 34;             //관제데코더전화번호
  KTTRINGCOUNT = 35;             //관제데코더전화번호
  DEVICERESET = 36;           //컨트롤러 리셋
  ARMDSCHECK = 37;            //경계시 DS체크
  ARMRELAYTYPE = 38;          //경계시 릴레이타입
  ALERTLAMPSIREN = 39;             //비상알람시램프사이렌
  ALERTLAMPTIME = 40;             //
  ALERTSIRENTIME = 41;             //
  USEDVRCHECK = 42;            //DVR사용 유무 체크
  DVRInfoCHECK = 43;            //DVR정보
  CARDREADERTELNUMBERCHECK = 44;            //카드리더 전화번호 체크
  SYSTEMFUNCTION = 45;            //기기기능 체크
  FTPFUNCTION = 46;               //FTP기능 체크
