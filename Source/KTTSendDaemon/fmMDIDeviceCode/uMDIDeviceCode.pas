...
type
  ...
  private
    ...
    Function InsertTB_ACCESSDEVICE(aNodeNo,aMcuID,aEcuID,aMcuIp,aMcuPort,aName,aBuildingCode,
                                   ...
                                   aGubun,aUpdate,aSystemId,aMuxId,aDecoderID,aTimeCodeType,aCardType,aSockType:string):Boolean;
    Function UpdateTB_ACCESSDEVICE(aNodeNo,aMcuID,aEcuID,aMcuIp,aMcuPort,aName,aBuildingCode,
                                   aFloorCode,aAreaCode,aRegState,aTotWidth,aTotHeight,
                                   aCurX,aCurY,aMcuAC,aMcuFd,aMcuPt,aMcuAt,aJavara,aSendAck,
                                   aUpdate,aSystemId,aMuxId,aDecoderID,aTimeCodeType,aCardType,aSockType:string):Boolean;
    Function UpdateTB_ACCESSDEVICEInfo(aNodeNo,aMcuID,aEcuID,aMcuIp,aMcuPort,aName,aBuildingCode,
                                   aFloorCode,aAreaCode,aRegState,aTotWidth,aTotHeight,
                                   aCurX,aCurY,aSystemId,aMuxId,aDecoderID,aTimeCodeType,aCardType,aSockType:string):Boolean;
    ...
    Function InsertAlarmDevice(aNodeNo,aEcuID,aName,aBuildingCode,aFloorCode,aAreaCode:string;bUpdate:Boolean=False):Boolean;
...
begin
  ...
  gbKTT.Visible := dmKTTControl.SERVERUSES;
end;
...
function TfmMDIDeviceCode.InsertTB_ACCESSDEVICE(aNodeNo,aMcuID, aEcuID, aMcuIp,
  ...
  aMcuAt,aJavara,aSendAck,aGubun,aUpdate,aSystemId,aMuxId,aDecoderID,aTimeCodeType,aCardType,aSockType:string): Boolean;
var
  stSql :string;
begin
  result := False;
...
function TfmMDIDeviceCode.UpdateTB_ACCESSDEVICE(aNodeNo,aMcuID, aEcuID, aMcuIp,
  aMcuPort, aName, aBuildingCode, aFloorCode, aAreaCode, aRegState,
  aTotWidth, aTotHeight, aCurX, aCurY, aMcuAC, aMcuFd, aMcuPt,
  aMcuAt,aJavara,aSendAck,aUpdate,aSystemId,aMuxId,aDecoderID,aTimeCodeType,aCardType,aSockType:string): Boolean;
var
  stSql :string;
begin
  result := False;
...
function TfmMDIDeviceCode.DupCheckMCU(aMcuIp,
...
begin
    ...
    begin
      if cmb_SockType.ItemIndex = 1 then bResult := DupCheckMCUID(Trim(ed_McuID.Text))
          ...
          begin
            ...
            begin
              ...
              if InsertTB_ACCESSDEVICE(ed_NodeNo.Text,ed_mcuid.Text,FillZeroNumber(i,2),
                                   ...
                                   '0','0','1','0','1','0','0','N','1','N','','','','0',inttostr(CARDLENGTHTYPE),'') then
              begin
                ...
                InsertAlarmDevice(ed_NodeNo.Text,FillZeroNumber(i,2),stEcuName,stBuildingCode,stFloorCode,stAreaCode,chk_PtName.Checked);
              end;
            end;
          end;
        end;
...
begin
    ...
    begin
      ...
      InsertAlarmDevice(stNodeNo,FillZeroNumber(ed_Ecuno.Value,2),ed_EcuName.Text,stBuildingCode,stFloorCode,stAreaCode,True);
...
function TfmMDIDeviceCode.UpdateTB_ACCESSDEVICEInfo(aNodeNo,aMcuID, aEcuID, aMcuIp,
  aMcuPort, aName, aBuildingCode, aFloorCode, aAreaCode, aRegState,
  aTotWidth, aTotHeight, aCurX, aCurY,aSystemId,aMuxId,aDecoderID,aTimeCodeType,aCardType,aSockType: string): Boolean;
var
  stSql :string;
begin
  result := False;
...
function TfmMDIDeviceCode.DupCheckMCUID(aMcuID: string): Boolean;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
begin
...
function TfmMDIDeviceCode.InsertAlarmDevice(aNodeNo, aEcuID, aName,
  aBuildingCode, aFloorCode, aAreaCode: string;bUpdate:Boolean=False): Boolean;
begin
