...
begin
  ...
  begin
    ...
    begin
      showmessage('빌딩코드를 선택하세요.');
      Exit;
    end;
    if Trim(ed_FloorCode.Text) = '' then
    begin
      showmessage('층코드가 없습니다.');
      ed_FloorCode.SetFocus;
      exit;
    end;
  ...
  begin
    ...
    begin
      showmessage('층코드를 선택하세요.');
      Exit;
    end;
    if Trim(ed_AreaCode.Text) = '' then
    begin
      showmessage('구역코드가 없습니다.');
      ed_AreaCode.SetFocus;
      exit;
    end;
...
begin
  ...
  begin
    ...
    begin
      showmessage('빌딩코드가 잘못 되었습니다.삭제불가!');
      Exit;
    end;
  ...
  begin
    ...
    if sFloorCode = '' then
    begin
      showmessage('층코드가 잘못 되었습니다.삭제불가!');
      Exit;
    end;
