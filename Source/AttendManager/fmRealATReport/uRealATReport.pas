...
type
  TfmRealATReport = class(TfmASubForm)
    GroupBox3: TGroupBox;
...
var
  fmRealATReport: TfmRealATReport;
...
procedure TfmRealATReport.btn_CloseClick(Sender: TObject);
begin
  Close;
end;

procedure TfmRealATReport.FormClose(Sender: TObject;
...
procedure TfmRealATReport.FormCreate(Sender: TObject);
begin
...
procedure TfmRealATReport.FormActivate(Sender: TObject);
var
  nIndex : integer;
begin
  dt_Date.Date := Now;

  GridInit(sg_report as TStringGrid,14);
...
procedure TfmRealATReport.cmb_CompanyChange(Sender: TObject);
begin
  LoadJijumCode(CompanyCodeList.Strings[cmb_Company.ItemIndex],JijumCodeList,cmb_Jijum);
  LoadDepartCode(copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],1,3),copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],4,3),DepartCodeList,cmb_Depart);
...
procedure TfmRealATReport.btn_SearchClick(Sender: TObject);
begin
  SearchATEvent('');
end;

procedure TfmRealATReport.btn_FileSaveClick(Sender: TObject);
var
  aFileName: String;
  sDate: String;
  eDate: String;
...
procedure TfmRealATReport.sg_reportColChanging(Sender: TObject; OldCol,
  NewCol: Integer; var Allow: Boolean);
begin
  with sg_report do
  begin
...
procedure TfmRealATReport.LoadInCode(cmb_Box: TComboBox);
var
  stSql :string;
begin
  cmb_Box.Clear;
...
procedure TfmRealATReport.LoadOutCode(cmb_Box: TComboBox);
var
  stSql :string;
begin
  cmb_Box.Clear;
...
function TfmRealATReport.InsertTB_ATEVENTInCode(aCompanyCode, aEmCode,
...
function TfmRealATReport.InsertTB_ATEVENTOutCode(aCompanyCode, aEmCode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmRealATReport.UpdateTB_ATEVENTInCode(aCompanyCode, aEmCode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmRealATReport.UpdateTB_ATEVENTOutCode(aCompanyCode, aEmCode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmRealATReport.DupCheckTB_ATEVENT(aCompanyCode, aEmCode,
...
procedure TfmRealATReport.sg_reportKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key <> #13 then exit;
  Key := #0;
...
procedure TfmRealATReport.SaveBigo(aCompanyCode, aEmCode, aDate,
  aData: string);
begin
...
procedure TfmRealATReport.SaveInTime(aCompanyCode, aEmCode, aDate,
  aData: string);
begin
...
procedure TfmRealATReport.SaveOutTime(aCompanyCode, aEmCode, aDate,
  aData: string);
begin
  aData := StringReplace(aData,':','',[rfReplaceAll]);
  aData := StringReplace(aData,'-','',[rfReplaceAll]);
...
function TfmRealATReport.InsertTB_ATEVENTBigo(aCompanyCode, aEmCode,
...
function TfmRealATReport.InsertTB_ATEVENTInTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmRealATReport.InsertTB_ATEVENTOutTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmRealATReport.UpdateTB_ATEVENTBigo(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmRealATReport.UpdateTB_ATEVENTInTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmRealATReport.UpdateTB_ATEVENTOutTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
procedure TfmRealATReport.CommandArrayCommandsTCommand0Execute(
...
function TfmRealATReport.SearchATEvent(aCode: string): Boolean;
var
  stSql : string;
  i :integer;
  nRow : integer;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Cells[11,nRow] := FindField('JIKAK').AsString;
        Cells[12,nRow] := FindField('Jotae').AsString;
        stOperator := FindField('AT_UPDATEOPERATOR').AsString;
        if UpperCase(stOperator) = 'SYSTEM' then stOperator := '';
        Cells[13,nRow] := stOperator;
        Cells[14,nRow] := FindField('AT_CONTENT').AsString;
        //Cells[12,nRow] := FindField('CA_CARDNO').AsString;
        Cells[16,nRow] := FindField('AT_INCODE').AsString;
        Cells[17,nRow] := FindField('AT_OUTCODE').AsString;
        Cells[18,nRow] := FindField('CO_COMPANYCODE').AsString;
        Cells[19,nRow] := FindField('AT_ATCODE').AsString;
...
procedure TfmRealATReport.cmb_JijumChange(Sender: TObject);
begin
  LoadDepartCode(copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],1,3),copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],4,3),DepartCodeList,cmb_Depart);
...
procedure TfmRealATReport.cmb_DepartChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmRealATReport.cmb_PosiChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmRealATReport.cmb_AtIntypeChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmRealATReport.cmb_AtOuttypeChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmRealATReport.Load_ATInCode(cmb_Box: TComboBox;
  bAllShow: Boolean);
var
  stSql : string;
begin
...
procedure TfmRealATReport.Load_ATOutCode(cmb_Box: TComboBox;
  bAllShow: Boolean);
var
  stSql : string;
begin
...
procedure TfmRealATReport.LoadATCode(cmb_Box: TComboBox);
var
  stSql :string;
begin
  cmb_Box.Clear;
...
function TfmRealATReport.InsertTB_ATEVENTATCode(aCompanyCode, aEmcode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmRealATReport.UpdateTB_ATEVENTATCode(aCompanyCode, aEmcode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
procedure TfmRealATReport.btn_ExcelClick(Sender: TObject);
var
...
function TfmRealATReport.GetTitle: String;
var
  stTitle : string;
begin
  stTitle := '날짜 : ' + FormatDateTime('yyyy-mm-dd',dt_Date.Date)  ;
...
procedure TfmRealATReport.sg_reportResize(Sender: TObject);
var
  nTotWidth: integer;
  nWidth : integer;
  nLeft : integer;
...
procedure TfmRealATReport.btn_PrintClick(Sender: TObject);
var
  stRefFileName,stSaveFileName:String;
  stPrintRefPath : string;
  nExcelRowStart:integer;
...
initialization
  RegisterClass(TfmRealATReport);
Finalization
  UnRegisterClass(TfmRealATReport);
