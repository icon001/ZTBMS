...
type
  TfmTheZonAtFileSave = class(TfmASubForm)
    GroupBox3: TGroupBox;
  ...
  private
    ...
    L_nEmCodeLen : integer;
    L_nAtGubunLen : integer;
    ...
    Function LoadConfigIni:Boolean;
...
var
  fmTheZonAtFileSave: TfmTheZonAtFileSave;
...
procedure TfmTheZonAtFileSave.btn_CloseClick(Sender: TObject);
begin
  Close;
end;

procedure TfmTheZonAtFileSave.FormClose(Sender: TObject;
...
procedure TfmTheZonAtFileSave.FormCreate(Sender: TObject);
begin
...
procedure TfmTheZonAtFileSave.FormActivate(Sender: TObject);
var
  nIndex : integer;
begin
...
procedure TfmTheZonAtFileSave.cmb_CompanyChange(Sender: TObject);
begin
  LoadJijumCode(CompanyCodeList.Strings[cmb_Company.ItemIndex],JijumCodeList,cmb_Jijum);
  LoadDepartCode(copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],1,3),copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],4,3),DepartCodeList,cmb_Depart);
...
procedure TfmTheZonAtFileSave.btn_SearchClick(Sender: TObject);
begin
  SearchATListEvent('');
end;

procedure TfmTheZonAtFileSave.btn_FileSaveClick(Sender: TObject);
var
  aFileName: String;
  sDate: String;
  eDate: String;
...
procedure TfmTheZonAtFileSave.sg_reportColChanging(Sender: TObject; OldCol,
  NewCol: Integer; var Allow: Boolean);
begin
  with sg_report do
  begin
...
procedure TfmTheZonAtFileSave.LoadInCode(cmb_Box: TComboBox);
var
  stSql :string;
begin
  cmb_Box.Clear;
...
procedure TfmTheZonAtFileSave.LoadOutCode(cmb_Box: TComboBox);
var
  stSql :string;
begin
  cmb_Box.Clear;
...
function TfmTheZonAtFileSave.InsertTB_ATEVENTInCode(aCompanyCode, aEmCode,
...
function TfmTheZonAtFileSave.InsertTB_ATEVENTOutCode(aCompanyCode, aEmCode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmTheZonAtFileSave.UpdateTB_ATEVENTInCode(aCompanyCode, aEmCode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmTheZonAtFileSave.UpdateTB_ATEVENTOutCode(aCompanyCode, aEmCode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmTheZonAtFileSave.DupCheckTB_ATEVENT(aCompanyCode, aEmCode,
...
procedure TfmTheZonAtFileSave.sg_reportKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key <> #13 then exit;
  Key := #0;
...
procedure TfmTheZonAtFileSave.SaveBigo(aCompanyCode, aEmCode, aDate,
  aData: string);
begin
...
procedure TfmTheZonAtFileSave.SaveInTime(aCompanyCode, aEmCode, aDate,
  aData: string);
begin
...
procedure TfmTheZonAtFileSave.SaveOutTime(aCompanyCode, aEmCode, aDate,
  aData: string);
begin
  aData := StringReplace(aData,':','',[rfReplaceAll]);
  aData := StringReplace(aData,'-','',[rfReplaceAll]);
...
function TfmTheZonAtFileSave.InsertTB_ATEVENTBigo(aCompanyCode, aEmCode,
...
function TfmTheZonAtFileSave.InsertTB_ATEVENTInTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmTheZonAtFileSave.InsertTB_ATEVENTOutTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmTheZonAtFileSave.UpdateTB_ATEVENTBigo(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmTheZonAtFileSave.UpdateTB_ATEVENTInTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmTheZonAtFileSave.UpdateTB_ATEVENTOutTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
procedure TfmTheZonAtFileSave.CommandArrayCommandsTCommand0Execute(
...
function TfmTheZonAtFileSave.SearchATListEvent(aCode: string): Boolean;
var
  stSql : string;
  i :integer;
  nRow : integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      with sg_report do
      begin
        Cells[0,nRow] := FillCharString(FindField('EM_CODE').AsString,' ',L_nEmCodeLen,True);
        ...
        Cells[3,nRow] := FillCharString(stATData,' ',L_nAtGubunLen,True);
...
procedure TfmTheZonAtFileSave.cmb_JijumChange(Sender: TObject);
begin
  LoadDepartCode(copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],1,3),copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],4,3),DepartCodeList,cmb_Depart);
...
procedure TfmTheZonAtFileSave.cmb_DepartChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmTheZonAtFileSave.cmb_PosiChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmTheZonAtFileSave.cmb_AtIntypeChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmTheZonAtFileSave.cmb_AtOuttypeChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmTheZonAtFileSave.Load_ATInCode(cmb_Box: TComboBox;
  bAllShow: Boolean);
var
  stSql : string;
begin
...
procedure TfmTheZonAtFileSave.Load_ATOutCode(cmb_Box: TComboBox;
  bAllShow: Boolean);
var
  stSql : string;
begin
...
procedure TfmTheZonAtFileSave.LoadATCode(cmb_Box: TComboBox);
var
  stSql :string;
begin
  cmb_Box.Clear;
...
function TfmTheZonAtFileSave.InsertTB_ATEVENTATCode(aCompanyCode, aEmcode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmTheZonAtFileSave.UpdateTB_ATEVENTATCode(aCompanyCode, aEmcode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
procedure TfmTheZonAtFileSave.btn_ExcelClick(Sender: TObject);
var
...
function TfmTheZonAtFileSave.GetTitle: String;
var
  stTitle : string;
begin
...
procedure TfmTheZonAtFileSave.sg_reportResize(Sender: TObject);
var
  nTotWidth: integer;
  nWidth : integer;
  nLeft : integer;
...
function TfmTheZonAtFileSave.ReportSaveToFile(aFileName: string): Boolean;
Var
  f: TextFile;
  stLine: string;
  stDir : string;
...
procedure TfmTheZonAtFileSave.btn_OptionClick(Sender: TObject);
begin
  inherited;
  fmTheZoneOption := TfmTheZoneOption.create(nil);
  fmTheZoneOption.EmCodeLen := L_nEmCodeLen;
  fmTheZoneOption.AtGubunLen := L_nAtGubunLen;
  fmTheZoneOption.ShowModal;
  fmTheZoneOption.Free;
  LoadConfigIni;
end;

function TfmTheZonAtFileSave.LoadConfigIni: Boolean;
var
  ini_fun : TiniFile;
begin
  ini_fun := TiniFile.Create(ExeFolder + '\thezoneatfile.ini');
  L_nEmCodeLen := ini_fun.ReadInteger('환경설정','EMCODELEN',7);
  L_nAtGubunLen := ini_fun.ReadInteger('환경설정','ATGubun',2);
  ini_fun.Free;
  sg_report.Cells[0,0] := '사원번호(' + inttostr(L_nEmCodeLen) + ')';
  sg_report.Cells[3,0] := '근태구분(' + inttostr(L_nAtGubunLen) + ')';

end;

initialization
  RegisterClass(TfmTheZonAtFileSave);
Finalization
  UnRegisterClass(TfmTheZonAtFileSave);
