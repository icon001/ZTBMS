...
type
  TfmAceAtFileSave = class(TfmASubForm)
    GroupBox3: TGroupBox;
...
var
  fmAceAtFileSave: TfmAceAtFileSave;
...
procedure TfmAceAtFileSave.btn_CloseClick(Sender: TObject);
begin
  Close;
end;

procedure TfmAceAtFileSave.FormClose(Sender: TObject;
...
procedure TfmAceAtFileSave.FormCreate(Sender: TObject);
begin
...
procedure TfmAceAtFileSave.FormActivate(Sender: TObject);
var
  nIndex : integer;
begin
...
procedure TfmAceAtFileSave.cmb_CompanyChange(Sender: TObject);
begin
  LoadJijumCode(CompanyCodeList.Strings[cmb_Company.ItemIndex],JijumCodeList,cmb_Jijum);
  LoadDepartCode(copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],1,3),copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],4,3),DepartCodeList,cmb_Depart);
...
procedure TfmAceAtFileSave.btn_SearchClick(Sender: TObject);
begin
  SearchATListEvent('');
end;

procedure TfmAceAtFileSave.btn_FileSaveClick(Sender: TObject);
var
  aFileName: String;
  sDate: String;
  eDate: String;
...
procedure TfmAceAtFileSave.sg_reportColChanging(Sender: TObject; OldCol,
  NewCol: Integer; var Allow: Boolean);
begin
  with sg_report do
  begin
...
procedure TfmAceAtFileSave.LoadInCode(cmb_Box: TComboBox);
var
  stSql :string;
begin
  cmb_Box.Clear;
...
procedure TfmAceAtFileSave.LoadOutCode(cmb_Box: TComboBox);
var
  stSql :string;
begin
  cmb_Box.Clear;
...
function TfmAceAtFileSave.InsertTB_ATEVENTInCode(aCompanyCode, aEmCode,
...
function TfmAceAtFileSave.InsertTB_ATEVENTOutCode(aCompanyCode, aEmCode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmAceAtFileSave.UpdateTB_ATEVENTInCode(aCompanyCode, aEmCode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmAceAtFileSave.UpdateTB_ATEVENTOutCode(aCompanyCode, aEmCode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmAceAtFileSave.DupCheckTB_ATEVENT(aCompanyCode, aEmCode,
...
procedure TfmAceAtFileSave.sg_reportKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key <> #13 then exit;
  Key := #0;
...
procedure TfmAceAtFileSave.SaveBigo(aCompanyCode, aEmCode, aDate,
  aData: string);
begin
...
procedure TfmAceAtFileSave.SaveInTime(aCompanyCode, aEmCode, aDate,
  aData: string);
begin
...
procedure TfmAceAtFileSave.SaveOutTime(aCompanyCode, aEmCode, aDate,
  aData: string);
begin
  aData := StringReplace(aData,':','',[rfReplaceAll]);
  aData := StringReplace(aData,'-','',[rfReplaceAll]);
...
function TfmAceAtFileSave.InsertTB_ATEVENTBigo(aCompanyCode, aEmCode,
...
function TfmAceAtFileSave.InsertTB_ATEVENTInTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmAceAtFileSave.InsertTB_ATEVENTOutTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmAceAtFileSave.UpdateTB_ATEVENTBigo(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmAceAtFileSave.UpdateTB_ATEVENTInTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
function TfmAceAtFileSave.UpdateTB_ATEVENTOutTime(aCompanyCode, aEmCode,
  aDate, aData: string): Boolean;
var
  stSql:string;
begin
...
procedure TfmAceAtFileSave.CommandArrayCommandsTCommand0Execute(
...
function TfmAceAtFileSave.SearchATListEvent(aCode: string): Boolean;
var
  stSql : string;
  i :integer;
  nRow : integer;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Cells[1,nRow] := stDate + ' ' + stTime;
        Cells[2,nRow] := stDate1 + ' ' + stTime1;
        Cells[3,nRow] := FindField('EM_NAME').AsString;
        Cells[4,nRow] := stATData;
        Cells[5,nRow] := FindField('COMPANY_NAME').AsString;
...
procedure TfmAceAtFileSave.cmb_JijumChange(Sender: TObject);
begin
  LoadDepartCode(copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],1,3),copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],4,3),DepartCodeList,cmb_Depart);
...
procedure TfmAceAtFileSave.cmb_DepartChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmAceAtFileSave.cmb_PosiChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmAceAtFileSave.cmb_AtIntypeChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmAceAtFileSave.cmb_AtOuttypeChange(Sender: TObject);
begin
  btn_SearchClick(Self);

end;

procedure TfmAceAtFileSave.Load_ATInCode(cmb_Box: TComboBox;
  bAllShow: Boolean);
var
  stSql : string;
begin
...
procedure TfmAceAtFileSave.Load_ATOutCode(cmb_Box: TComboBox;
  bAllShow: Boolean);
var
  stSql : string;
begin
...
procedure TfmAceAtFileSave.LoadATCode(cmb_Box: TComboBox);
var
  stSql :string;
begin
  cmb_Box.Clear;
...
function TfmAceAtFileSave.InsertTB_ATEVENTATCode(aCompanyCode, aEmcode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
function TfmAceAtFileSave.UpdateTB_ATEVENTATCode(aCompanyCode, aEmcode,
  aDate, aCode: string): Boolean;
var
  stSql : string;
begin
...
procedure TfmAceAtFileSave.btn_ExcelClick(Sender: TObject);
var
...
function TfmAceAtFileSave.GetTitle: String;
var
  stTitle : string;
begin
...
procedure TfmAceAtFileSave.sg_reportResize(Sender: TObject);
var
  nTotWidth: integer;
  nWidth : integer;
  nLeft : integer;
...
initialization
  RegisterClass(TfmAceAtFileSave);
Finalization
  UnRegisterClass(TfmAceAtFileSave);
