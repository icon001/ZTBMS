...
begin
  ...
  stRefFileName  := ini_fun.ReadString('기간별근태보고서','참조파일','D2DATReport.xls');
  stRefFileName := stPrintRefPath + stRefFileName;
  stSaveFileName := '';
  nExcelRowStart := ini_fun.ReadInteger('기간별근태보고서','시작위치',6);
  ini_fun.Free;
...
begin
  ...
  if G_nCompanyCodeType = 1 then  //일반적인 상태
  begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Cells[13,nRow] := FindField('AT_CODENAME').AsString;  //근무타입
