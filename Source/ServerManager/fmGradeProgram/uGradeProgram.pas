...
begin
  Panel12.Caption := fmGradeProgram.Caption;
  LoadProgramGroup;
  LoadMenuGroup;
//  LoadGradeMenuGroup;
  LoadGradeCode;
...
begin
  ...
  cmb_ProgramGroup.Items.Add('출입통제관제시스템');
  ProgramGroupCodeList.Add('MONITORING');
...
begin
  ...
  if DBTYPE = 'MSSQL' then stSql := MSSQL.SelectTB_GRADEPROGRAMGradeJoinBase(GradeCodeList.Strings[cmb_Grade.ItemIndex],ProgramGroupCodeList.Strings[cmb_ProgramGroup.ItemIndex])
  else if DBTYPE = 'PG' then stSql := PostGreSql.SelectTB_GRADEPROGRAMGradeJoinBase(GradeCodeList.Strings[cmb_Grade.ItemIndex],ProgramGroupCodeList.Strings[cmb_ProgramGroup.ItemIndex])
  else if DBTYPE = 'MDB' then stSql := MDBSql.SelectTB_GRADEPROGRAMGradeJoinBase(GradeCodeList.Strings[cmb_Grade.ItemIndex],ProgramGroupCodeList.Strings[cmb_ProgramGroup.ItemIndex])
  else if DBTYPE = 'FB' then stSql := FireBird.SelectTB_GRADEPROGRAMGradeJoinBase(GradeCodeList.Strings[cmb_Grade.ItemIndex],ProgramGroupCodeList.Strings[cmb_ProgramGroup.ItemIndex])
  else Exit;
