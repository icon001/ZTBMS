...
function TfmDeviceCode.InsertTB_ACCESSDEVICE(aNodeNo,aMcuID, aEcuID, aMcuIp,
  ...
  aMcuAt,aSendAck,aCardReaderType,aGubun,aUpdate,aSystemId,aMuxId,aDecoderID:string): Boolean;
var
  stSql :string;
begin
  result := False;
...
function TfmDeviceCode.UpdateTB_ACCESSDEVICE(aNodeNo,aMcuID, aEcuID, aMcuIp,
  aMcuPort, aName, aBuildingCode, aFloorCode, aAreaCode, aRegState,
  aTotWidth, aTotHeight, aCurX, aCurY, aMcuAC, aMcuFd, aMcuPt,
  aMcuAt,aSendAck,aCardReaderType,aUpdate,aSystemId,aMuxId,aDecoderID:string): Boolean;
var
  stSql :string;
begin
  result := False;
          ...
          begin
            ...
            begin
              ...
              if InsertTB_ACCESSDEVICE(ed_NodeNo.Text,ed_mcuid.Text,FillZeroNumber(i,2),
                                   ...
                                   '0','0','1','0','1','0','N',inttostr(cmb_CardReaderType.ItemIndex),'1','N','','','') then
              begin
                ...
                InsertAlarmDevice(ed_NodeNo.Text,FillZeroNumber(i,2),stEcuName,stBuildingCode,stFloorCode,stAreaCode,True);
              end;
            end;
          end;
        end;
...
begin
    ...
    begin
      if chk_ECUPtName.Checked then InsertAlarmDevice(inttostr(strtoint(stNodeNo)),FillZeroNumber(ed_Ecuno.Value,2),ed_EcuName.Text,stBuildingCode,stFloorCode,stAreaCode,True)
      else  InsertAlarmDevice(inttostr(strtoint(stNodeNo)),FillZeroNumber(ed_Ecuno.Value,2),ed_EcuName.Text,stBuildingCode,stFloorCode,stAreaCode);
    end else
    begin
...
function TfmDeviceCode.UpdateTB_ACCESSDEVICEInfo(aNodeNo,aMcuID, aEcuID, aMcuIp,
  aMcuPort, aName, aBuildingCode, aFloorCode, aAreaCode, aRegState,
  aTotWidth, aTotHeight, aCurX, aCurY,aSystemId,aMuxId,aDecoderID: string): Boolean;
var
  stSql :string;
begin
  result := False;
