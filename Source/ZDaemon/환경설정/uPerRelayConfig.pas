...
begin
    ...
    begin
      ...
      conStr := constr + 'Password=' + ed_DBPasswd2.text + ';';
      conStr := constr + 'User ID='+ ed_DBUser2.Text + ';';
      conStr := constr + 'Data Source=' + ed_DBName2.Text + ';';
      conStr := constr + 'Persist Security Info=False';   
      //conStr := constr + 'Persist Security Info=True';  False
    end else if cmb_DBType2.ItemIndex = 4 then  //Oracle OleDB
    begin
      //conStr := 'Provider=OraOLEDB.Oracle;';
      //conStr := constr + 'Data Source=(DESCRIPTION=(CID=GTU_APP)(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=' + aServerIP + ')(PORT=' + aServerPort + ')))(CONNECT_DATA=(SID=' + aDataBaseName + ')(SERVER=DEDICATED)));';
      conStr := 'Provider=OraOLEDB.Oracle;';
      conStr := constr + 'Data Source=(DESCRIPTION=(CID=GTU_APP)(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=' + ed_ServerIP2.Text + ')(PORT=' + ed_ServerPort2.Text + ')))(CONNECT_DATA=(SERVICE_NAME=' + ed_DBName2.Text + ')(SERVER=DEDICATED)));';
      conStr := constr + 'User Id='+ ed_DBUser2.Text + ';';
      conStr := constr + 'Password=' + ed_DBPasswd2.text + '';
    end else if cmb_DBType2.ItemIndex = 5 then  //ODBC
    begin
