  ...
  begin
      ...
      begin
        ...
        case TDevice(DeviceList.Objects[i]).GetDoorManageMode(1) of
          ...
          dmManager : begin stDoorManager1 := '운영모드' end;
          dmOpen    : begin stDoorManager1 := '개방모드' end;
          dmLock    : begin stDoorManager1 := '폐쇄모드' end;
          dmMaster  : begin stDoorManager1 := '마스터모드' end;
        ...
        case TDevice(DeviceList.Objects[i]).GetDoorManageMode(2) of
          ...
          dmManager : begin stDoorManager2 := '운영모드' end;
          dmOpen    : begin stDoorManager2 := '개방모드' end;
          dmLock    : begin stDoorManager2 := '폐쇄모드' end;
          dmMaster  : begin stDoorManager2 := '마스터모드' end;
        ...
        case TDevice(DeviceList.Objects[i]).GetDoorState(1) of
          ...
          dsClose   : begin stDoorOpenState1 := '닫힘' end;
          dsOpen    : begin stDoorOpenState1 := '열림' end;
          dsLongTime: begin stDoorOpenState1 := '장시간' end;
          dsOpenErr : begin stDoorOpenState1 := '열림에러' end;
          dsCloseErr: begin stDoorOpenState1 := '닫힘에러' end;
        ...
        case TDevice(DeviceList.Objects[i]).GetDoorState(2) of
          ...
          dsClose   : begin stDoorOpenState2 := '닫힘' end;
          dsOpen    : begin stDoorOpenState2 := '열림' end;
          dsLongTime: begin stDoorOpenState2 := '장시간' end;
          dsOpenErr : begin stDoorOpenState2 := '열림에러' end;
          dsCloseErr: begin stDoorOpenState2 := '닫힘에러' end;
