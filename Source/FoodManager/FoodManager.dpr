...
uses
  ...
  uFoodCountReport in 'fmFoodCountReport\uFoodCountReport.pas' {fmFoodCountReport},
  ...
  uFoodReInsert in 'fmFoodReInsert\uFoodReInsert.pas' {fmFoodReInsert},
  uDBFunction in '..\..\Lib\DataBase\uDBFunction.pas' {dmDBFunction: TDataModule},
  uFoodEventInsert in '..\..\Lib\Food\uFoodEventInsert.pas' {dmDBFoodEvent: TDataModule},
...
begin
  ...
  Application.CreateForm(TdmDBFoodEvent, dmDBFoodEvent);
  Application.CreateForm(TfmMain, fmMain);
  Application.CreateForm(TdmAdoQuery, dmAdoQuery);
  Application.CreateForm(TdmExcelSave, dmExcelSave);
