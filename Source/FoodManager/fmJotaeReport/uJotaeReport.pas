...
type
  TfmJotaeReport = class(TfmASubForm)
    GroupBox1: TGroupBox;
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
procedure TfmJotaeReport.btn_CloseClick(Sender: TObject);
begin
  Close;

end;

procedure TfmJotaeReport.FormActivate(Sender: TObject);
begin
...
procedure TfmJotaeReport.LoadCompanyCode(cmb_Box: TComboBox);
var
  stSql :string;
begin
  cmb_Box.Clear;
...
procedure TfmJotaeReport.LoadDepartCode(aCompanyCode: string;
  cmb_Box: TComboBox);
var
  stSql :string;
begin
...
procedure TfmJotaeReport.FormCreate(Sender: TObject);
begin
...
procedure TfmJotaeReport.FormClose(Sender: TObject;
...
procedure TfmJotaeReport.cmb_CompanyChange(Sender: TObject);
begin
  LoadDepartCode(CompanyCodeList.Strings[cmb_Company.ItemIndex],cmb_Depart);

end;

procedure TfmJotaeReport.btn_SearchClick(Sender: TObject);
var
  stSql : string;
  i : integer;
  nRow : integer;
begin
  ...
  stSql := stSql + ' AND a.AT_OUTRESULT = ''N'' ';
...
procedure TfmJotaeReport.btn_FileSaveClick(Sender: TObject);
var
  aFileName: String;
  sDate: String;
  eDate: String;
...
procedure TfmJotaeReport.frReport1GetValue(const ParName: String;
  var ParValue: Variant);
begin
...
procedure TfmJotaeReport.btn_PrintClick(Sender: TObject);
begin
...
initialization
  RegisterClass(TfmJotaeReport);
Finalization
  UnRegisterClass(TfmJotaeReport);
