...
begin
  ...
  begin
    if Not fmMain.Check_JavaraOpen(copy(stDoorID,1,3),copy(stDoorID,4,2),copy(stDoorID,6,1)) then
    begin
  ...
  begin
    if Not fmMain.Check_JavaraClose(copy(stDoorID,1,3),copy(stDoorID,4,2),copy(stDoorID,6,1)) then
    begin
