...
begin
  ...
  begin
    ...
    if (rg_readerType.ItemIndex = 0) and (rg_fdmsdbtype.ItemIndex = 1) then
    begin
...
begin
  ...
  begin
    ...
    begin
      showmessage('KT사옥용 프로그램에서는 사용할 수 없는 기능입니다.');
...
begin
  if cmb_Special.ItemIndex = 1 then rg_kttControlServerUses.ItemIndex := 0;
