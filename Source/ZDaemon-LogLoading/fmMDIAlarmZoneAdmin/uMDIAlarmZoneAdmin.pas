...
procedure TfmMDIAlarmZoneAdmin.AlarmZoneSearch(aAlarmNo,
...
begin
  ...
  begin
    ...
    cmb_regAlarmCode.ItemIndex := sALARMIDList.IndexOf(ed_AlarmNo.Text);
...
procedure TfmMDIAlarmZoneAdmin.cmb_AlarmCodeChange(Sender: TObject);
var
  stAlarmNo : string;
begin
