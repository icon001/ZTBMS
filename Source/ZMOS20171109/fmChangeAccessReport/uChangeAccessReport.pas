...
begin
  ...
  self.FindSubForm('Main').FindCommand('FORMSHOW').Params.Values['VALUE'] := 'ChangeAccessReport';
...
begin
  Try
    ...
    else if cmb_Type.ItemIndex = 2 then //카드번호
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            cells[12,nRow] := FindField('CT_NAME').AsString;
          end;
...
procedure TfmChangeAccessReport.CommandArrayCommandsTCloseExecute(
  Command: TCommand; Params: TStringList);
begin
  inherited;
  Close;
