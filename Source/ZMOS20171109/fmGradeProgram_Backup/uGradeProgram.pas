...
begin
  ...
  cmb_ProgramGroup.Items.Add('전체');
  ProgramGroupCodeList.Add('');
  cmb_ProgramGroup.Items.Add('관제프로그램');
  ProgramGroupCodeList.Add('KTMOS');
  cmb_ProgramGroup.Items.Add('보고서프로그램');
  ProgramGroupCodeList.Add('KTREPORT');


  cmb_GradeProgramGroup.Clear;
  cmb_GradeProgramGroup.Items.Add('전체');
  cmb_GradeProgramGroup.Items.Add('관제프로그램');
  cmb_GradeProgramGroup.Items.Add('보고서프로그램');
...
begin
  ...
  begin
    ...
    cmb_GradeMenuGroup.Items.Add('전체');
  end
  else begin
    MenuGradeGroupCodeList.Add('');
    cmb_GradeMenuGroup.Items.Add('전체');
