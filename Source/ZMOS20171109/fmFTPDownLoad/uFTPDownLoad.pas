  ...
  begin
    ...
    begin
      ...
      begin
        ...
        //공휴일 데이터 재전송,
        dmDBFunction.UpdateTB_ACCESSDEVICE_Field_StringValue(cells[4,DeviceLoop],cells[1,DeviceLoop],'HO_SEND','N');
        //스케줄 재전송
        dmDBFunction.UpdateTB_DEVICESCHEDULE_Field_StringValue(cells[4,DeviceLoop],cells[1,DeviceLoop],'','','DE_RCVACK','N');
