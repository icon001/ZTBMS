...
type
  TfmMCCardAdmin = class(TfmASubForm)
...
procedure TfmMCCardAdmin.btn_CloseClick(Sender: TObject);
begin
  Close;
end;

procedure TfmMCCardAdmin.FormActivate(Sender: TObject);
var
  nIndex : integer;
begin
  ...
  FormNameSet;
  Panel2.Caption := fmCardAdmin.Caption;
  if G_nSearchIndex = 0 then btn_SearchClick(Self);
end;

procedure TfmMCCardAdmin.cmb_CompanyChange(Sender: TObject);
begin
  LoadJijumCode(CompanyCodeList.Strings[cmb_Company.ItemIndex],JijumCodeList,cmb_Jijum);
  LoadDepartCode(copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],1,3),copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],4,3),DepartCodeList,cmb_Depart);
  LoadPosiCode(CompanyCodeList.Strings[cmb_Company.ItemIndex],PosiCodeList,cmb_Posi);
...
procedure TfmMCCardAdmin.FormCreate(Sender: TObject);
begin
...
procedure TfmMCCardAdmin.FormClose(Sender: TObject;
...
procedure TfmMCCardAdmin.GetDepartCodeList;
var
  stSql : String;
...
procedure TfmMCCardAdmin.btn_SearchClick(Sender: TObject);
var
  stSql : string;
  nRow : integer;
  i : integer;
...
procedure TfmMCCardAdmin.GridInit(sg: TAdvStringGrid; aCol: integer);
var
  i:integer;
begin
  with sg do
...
procedure TfmMCCardAdmin.chk_CardRegClick(Sender: TObject);
var
  nCount : integer;
  i : integer;
  stTemp : string;
...
function TfmMCCardAdmin.DecodeCommportName(PortName: String): WORD;
var
 Pt : Integer;
begin
...
function TfmMCCardAdmin.EncodeCommportName(PortNum: WORD): String;
begin
 if PortNum < 10
...
function TfmMCCardAdmin.GetSerialPortList(List: TStringList;
...
procedure TfmMCCardAdmin.ApdDataPacket1StringPacket(Sender: TObject;
  Data: String);
begin
...
procedure TfmMCCardAdmin.RcvCardDataByReader(aData: String);
var
  aIndex: Integer;
  aCardNo:String;
  bCardNo: int64;
...
procedure TfmMCCardAdmin.CheckBoxClick(Sender: TObject; ACol, ARow: Integer;
  State: Boolean);
begin
...
procedure TfmMCCardAdmin.AdvStrinGridSetAllCheck(Sender: TObject;
  bchkState: Boolean);
var
  i : integer;
begin
...
procedure TfmMCCardAdmin.cmb_DepartChange(Sender: TObject);
begin
  if G_nSearchIndex = 0 then btn_SearchClick(Self);
end;

procedure TfmMCCardAdmin.cmb_PosiChange(Sender: TObject);
begin
  if G_nSearchIndex = 0 then btn_SearchClick(Self);
end;

procedure TfmMCCardAdmin.ed_EmpNoKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure TfmMCCardAdmin.ed_EmpNMKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure TfmMCCardAdmin.ed_CardNoKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure TfmMCCardAdmin.sg_CardClick(Sender: TObject);
var
  bchkState : Boolean;
...
procedure TfmMCCardAdmin.LoadBuildingCode(cmb_Box: TComboBox);
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
...
procedure TfmMCCardAdmin.LoadsBuildingCode(cmb_Box: TComboBox);
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
...
procedure TfmMCCardAdmin.cmb_BuildingCodeChange(Sender: TObject);
var
  stBuildingCode,stFloorCode,stAreaCode:string;
begin
  stBuildingCode := BuildingCodeList.Strings[ cmb_BuildingCode.itemindex ];
...
procedure TfmMCCardAdmin.LoadAreaCode(aBuildingCode, aFloorCode: string;
  cmb_Box: TComboBox);
var
  stSql : string;
begin
...
procedure TfmMCCardAdmin.LoadFloorCode(aBuildingCode: string;
  cmb_Box: TComboBox);
var
  stSql : string;
begin
...
procedure TfmMCCardAdmin.LoadsAreaCode(aBuildingCode, aFloorCode: string;
  cmb_Box: TComboBox);
var
  stSql : string;
begin
...
procedure TfmMCCardAdmin.LoadsFloorCode(aBuildingCode: string;
  cmb_Box: TComboBox);
var
  stSql : string;
begin
...
procedure TfmMCCardAdmin.DoorCodeSearch(aBuildingCode, aFloorCode,
...
procedure TfmMCCardAdmin.AlarmCodeSearch(aBuildingCode, aFloorCode,
  aAreaCode: string; sg: TAdvStringGrid);
var
  stSql : string;
  nRow : integer;
...
procedure TfmMCCardAdmin.DoorSearch;
var
  stBuildingCode,stFloorCode,stAreaCode:string;
begin
  stBuildingCode := BuildingCodeList.Strings[ cmb_BuildingCode.itemindex ];
...
procedure TfmMCCardAdmin.AlarmSearch;
var
  stBuildingCode,stFloorCode,stAreaCode:string;
begin
  stBuildingCode := BuildingCodeList.Strings[ cmb_BuildingCode1.itemindex ];
...
procedure TfmMCCardAdmin.FoodSearch;
var
  stBuildingCode,stFloorCode,stAreaCode:string;
begin
  stBuildingCode := BuildingCodeList.Strings[ cmb_BuildingCode2.itemindex ];
...
procedure TfmMCCardAdmin.PageControl1Change(Sender: TObject);
begin
  if PageControl1.ActivePage.Name  = 'DoorTab' then    DoorSearch
  else if PageControl1.ActivePage.Name  = 'AlarmTab' then  AlarmSearch
  else if PageControl1.ActivePage.Name  = 'FoodTab' then FoodSearch;
...
procedure TfmMCCardAdmin.FoodCodeSearch(aBuildingCode,aFloorCode,aAreaCode:string;sg: TAdvStringGrid);
var
  stSql : string;
  nRow : integer;
  i : integer;
...
procedure TfmMCCardAdmin.AlarmGradeSearch(aBuildingCode,aFloorCode,aAreaCode,aCardNo:string;
  sg: TAdvStringGrid);
var
  stSql : string;
  nRow : integer;
...
procedure TfmMCCardAdmin.DoorGradeSearch(aBuildingCode,aFloorCode,aAreaCode,aCardNo: string;
  sg: TAdvStringGrid);
var
  stSql : string;
  nRow : integer;
...
procedure TfmMCCardAdmin.FoodGradeSearch(aBuildingCode,aFloorCode,aAreaCode,aCardNo:string;
  sg: TAdvStringGrid);
var
  stSql : string;
  nRow : integer;
...
procedure TfmMCCardAdmin.cmb_BuildingCode1Change(Sender: TObject);
var
  stBuildingCode,stFloorCode,stAreaCode:string;
begin
  stBuildingCode := BuildingCodeList.Strings[ cmb_BuildingCode1.itemindex ];
...
procedure TfmMCCardAdmin.cmb_BuildingCode2Change(Sender: TObject);
var
  stBuildingCode,stFloorCode,stAreaCode:string;
begin
  stBuildingCode := BuildingCodeList.Strings[ cmb_BuildingCode2.itemindex ];
...
procedure TfmMCCardAdmin.cmb_FloorCodeChange(Sender: TObject);
var
...
procedure TfmMCCardAdmin.cmb_FloorCode1Change(Sender: TObject);
var
  stBuildingCode : string;
  stFloorCode : string;
  stAreaCode : string;
...
procedure TfmMCCardAdmin.cmb_FloorCode2Change(Sender: TObject);
var
  stBuildingCode : string;
  stFloorCode : string;
  stAreaCode : string;
...
procedure TfmMCCardAdmin.cmb_AreaCodeChange(Sender: TObject);
var
  stBuildingCode,stFloorCode,stAreaCode:string;
begin
  stBuildingCode := BuildingCodeList.Strings[cmb_BuildingCode.itemIndex];
...
procedure TfmMCCardAdmin.cmb_AreaCode1Change(Sender: TObject);
var
  stBuildingCode,stFloorCode,stAreaCode:string;
begin
  stBuildingCode := BuildingCodeList.Strings[cmb_BuildingCode1.itemIndex];
...
procedure TfmMCCardAdmin.cmb_AreaCode2Change(Sender: TObject);
var
  stBuildingCode,stFloorCode,stAreaCode:string;
begin
  stBuildingCode := BuildingCodeList.Strings[cmb_BuildingCode2.itemIndex];
...
procedure TfmMCCardAdmin.sg_CardCheckBoxClick(Sender: TObject; ACol,
...
procedure TfmMCCardAdmin.btn_GradeInsertClick(Sender: TObject);
var
  stBuildingCode,stFloorCode,stAreaCode : string;
...
procedure TfmMCCardAdmin.DeleteAlarmGrade;
var
...
procedure TfmMCCardAdmin.DeleteDoorGrade;
var
...
procedure TfmMCCardAdmin.DeleteFoodGrade;
var
...
procedure TfmMCCardAdmin.InsertAlarmGrade;
var
  UserLoop,AlarmLoop : integer;
  bchkState : Boolean;
  stNodeNo,stECUID,stDoorNO : string;
...
procedure TfmMCCardAdmin.InsertDoorGrade;
var
  UserLoop,DoorLoop : integer;
  bchkState : Boolean;
  stNodeNo,stECUID,stDoorNO : string;
...
procedure TfmMCCardAdmin.InsertFoodGrade;
var
  UserLoop,FoodLoop : integer;
  bchkState : Boolean;
  stNodeNo,stECUID,stDoorNo : string;
...
function TfmMCCardAdmin.CheckTB_DEVICECARDNO(aCardNo, aNodeNo,
...
function TfmMCCardAdmin.InsertTB_DEVICECARDNO(aCardNo, aNodeNo,
...
function TfmMCCardAdmin.UpdateTB_DEVICECARDNO(aCardNo, aNodeNo,
  aECUID, aDoorNO,aTimCode, aPermit,aValue, aGubun: string): Boolean;
var
  stSql : string;
begin
...
procedure TfmMCCardAdmin.btn_GradeDeleteClick(Sender: TObject);
var
  i : integer;
  bChkState : Boolean;
...
procedure TfmMCCardAdmin.chk_NonGradeClick(Sender: TObject);
begin
  if G_nSearchIndex = 0 then btn_SearchClick(Self);
end;

procedure TfmMCCardAdmin.cmb_ComPortChange(Sender: TObject);
begin
...
procedure TfmMCCardAdmin.FormShow(Sender: TObject);
begin
  if Not IsMaster then
  begin
...
procedure TfmMCCardAdmin.cmb_JijumChange(Sender: TObject);
begin
  LoadDepartCode(copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],1,3),copy(JijumCodeList.Strings[cmb_Jijum.ItemIndex],4,3),DepartCodeList,cmb_Depart);
  if G_nSearchIndex = 0 then btn_SearchClick(Self);
end;

procedure TfmMCCardAdmin.FormNameSet;
begin
...
procedure TfmMCCardAdmin.CenterPanel;
var
...
begin
  nStartH := 65;
  nStartW := 0;
  nTotW := fmCardAdmin.Width;
  nTotH := fmCardAdmin.Height;
...
procedure TfmMCCardAdmin.FormResize(Sender: TObject);
begin
  CenterPanel;
end;

procedure TfmMCCardAdmin.SettingSearcheDoorGrade(aNodeNo: integer; aEcuID,
  aDoorNo: string);
var
  nRow : integer;
begin
...
procedure TfmMCCardAdmin.ClearSearcheDoorGrade;
var
  nRow : integer;
begin
  with sg_Door do
...
function TfmMCCardAdmin.UpdateTB_CARDDOORGRADE(aCardNo,
