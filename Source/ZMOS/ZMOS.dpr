...
uses
  ...
  uBuildingAlarmReport in 'fmBuildingAlarmReport\uBuildingAlarmReport.pas' {fmBuildingAlarmReport},
  ...
  uMDIAlarmGrade in 'fmMDIAlarmGrade\uMDIAlarmGrade.pas' {fmMDIAlarmGrade},
  ...
  uInOutStateList in 'fmInOutStateList\uInOutStateList.pas' {fmInOutStateList},
  uAlarmHistory in 'fmAlarmHistory\uAlarmHistory.pas' {fmAlarmHistory},
  uKTCardReg in 'fmKTCardReg\uKTCardReg.pas' {fmKTCardReg},
  ...
  ArmGubunCode in 'fmArmGubunCode\ArmGubunCode.pas' {fmArmGubunCode},
  ...
  uZoneStateReport in 'fmZoneStateReport\uZoneStateReport.pas' {fmZoneStateReport},
  uTimeNotAccessReport in 'fmTimeNotAccessReport\uTimeNotAccessReport.pas' {fmTimeNotAccessReport},
  ...
  uCardAccessTime in 'fmCardAccessTime\uCardAccessTime.pas' {fmCardAccessTime},
  ...
  uBuildingAccessTypeMonitoring in 'fmBuildingAccessTypeMonitoring\uBuildingAccessTypeMonitoring.pas' {fmBuildingAccessTypeMonitoring},
  ...
  uCardSearch in 'fmCardAdminReport\uCardSearch.pas' {fmCardSearch},
  ...
  uAccessMapMonitoring in 'fmAccessMapMonitoring\uAccessMapMonitoring.pas' {fmAccessMapMonitoring},
  ...
  uZoneMap in 'fmKTTypeMonitoring\uZoneMap.pas' {fmZoneMap},
  uRemoteSupport in 'fmRemoteSupport\uRemoteSupport.pas' {fmRemoteSupport},
  uNotPTListReport in 'fmNotPTListReport\uNotPTListReport.pas' {fmNotPTListReport},
  uAccessReport in 'fmAccessReport\uAccessReport.pas' {fmAccessReport},
  uBuildingAccessReport in 'fmBuildingAccessReport\uBuildingAccessReport.pas' {fmBuildingAccessReport},
  udmServerToMonitor in '..\..\Lib\udmServerToMonitor.pas' {dmServerToMonitor: TDataModule},
  uArmGradeReport in 'fmArmGradeReport\uArmGradeReport.pas' {fmArmGradeReport},
  uDoorGradeReport in 'fmDoorGradeReport\uDoorGradeReport.pas' {fmDoorGradeReport},
  ...
  uAlarmGroup in 'fmAlarmGroup\uAlarmGroup.pas' {fmAlarmGroup},
  ...
  uJavara in '..\..\Lib\Javara\uJavara.pas' {dmJavara: TDataModule},
  uJavaraschedule in 'fmJavaraschedule\uJavaraschedule.pas' {fmJavaraschedule},
  uTreeEmployee in 'fmTreeEmployee\uTreeEmployee.pas' {fmTreeEmployee},
  ...
  uMDIDoorGrade in 'fmMDIDoorGrade\uMDIDoorGrade.pas' {fmMDIDoorGrade},
  uTimeAccessReport in 'fmTimeAccessReport\uTimeAccessReport.pas' {fmTimeAccessReport},
  uEmCodeChange in 'fmEmCodeChange\uEmCodeChange.pas' {fmEmCodeChange},
  uAlarmAccessReport in 'fmAlarmAccessReport\uAlarmAccessReport.pas' {fmAlarmAccessReport},
  uDeviceTimeCode in 'fmDeviceTimeCode\uDeviceTimeCode.pas' {fmDeviceTimeCode},
...
begin
  ...
  Application.CreateForm(TdmJavara, dmJavara);
