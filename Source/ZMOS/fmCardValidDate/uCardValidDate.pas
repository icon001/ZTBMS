...
begin
  ...
  cmb_SearchTypeChange(cmb_SearchType);
  ...
  begin
    ...
    begin
      ...
      if cmb_SearchType.ItemIndex = 0 then //사번
        stSql := stSql + ' AND b.EM_CODE = ''' + Trim(ed_searchText.Text)  + ''' '
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          stCardState :='';
          if( Not FindField('CA_CARDTYPE').IsNull ) then
          begin
  ...
  Try
    ...
    begin
      ...
      begin
        ...
        begin
          Gauge1.Progress := Gauge1.Progress + 1;
          if DleteCard(cells[0,i]) then
            dmAdoQuery.DeleteTB_EMPLOYEE(cells[7,i],cells[9,i],cells[0,i]);
