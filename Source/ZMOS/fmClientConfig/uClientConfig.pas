...
begin
  ...
  if chk_ZoneMap.Checked then G_nZoneMapPopup := 1
  else G_nZoneMapPopup := 0;
  ...
  LMDIniCtrl1.WriteInteger('Monitoring','ZoneMap',G_nZoneMapPopup);
...
begin
  ...
  if G_nZoneMapPopup = 1 then chk_ZoneMap.Checked := True
  else chk_ZoneMap.Checked := False;
...
begin
  ...
  begin
    ...
    if (cmb_MonitorType.ItemIndex = 2) then
    begin
      chk_AlarmMap.Visible := True;
      chk_ZoneMap.Visible := True;
    end;
  end else
  begin
