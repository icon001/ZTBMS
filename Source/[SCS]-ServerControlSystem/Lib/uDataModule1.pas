...
//  ATTENDTYPE : String; //근태사용타입(BUTTON/UPDATE/READERNO(1/2))
  ...
  HidCardType : integer;        //0:범용 카드,1: HID 거꾸로 읽히는 카드 
  ...
  CARDLENGTHTYPE : integer; //카드번호 타입 0:고정4Byte 1:고정20Byte 2:HEX<->ASCII
  ...
  DisplayList : TStringList; //Display 리스트
  BarCodeList : TStringList; //바코드 리스트
  G_stSoundCode: Array [0..9] of String;  //사운드코드 리스트
  ...
  G_nSCSRelayServer : integer; //0:Kyunghee Campus,1:KT비즈메카,2:인천대공원
  ...
  nSpecialProgram : integer;  //특화서비스 0: 범용,1:KT서초사옥
