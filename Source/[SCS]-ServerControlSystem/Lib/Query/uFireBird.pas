...
function TFireBird.AlterTB_ACCESSEVENTAUTHTYPE: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSEVENT ADD AC_AUTHTYPE varchar(3) DEFAULT ''000'' ';
  result := stSql;
...
function TFireBird.AlterTB_ACCESSEVENTSCSHIS: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSEVENT ADD AC_SCSHIS varchar(5)  ';
  result := stSql;
...
function TFireBird.AlterTB_DoorSoundIP: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DOOR ADD DO_SOUNDIP varchar(30) ';
  result := stSql;

end;

function TFireBird.AlterTB_DoorSoundPort: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DOOR ADD DO_SOUNDPORT varchar(30) ';
  result := stSql;

end;

function TFireBird.AlterTB_DoorSoundVolume: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DOOR ADD DO_SOUNDVOLUME varchar(30) ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_POSI ADD PO_UPDATECHECK char(1) DEFAULT ''N'' ';
  result := stSql;
...
function TFireBird.CreateSEAT_USER_VIEW: string;
var
  stSql : string;
begin
...
function TFireBird.CreateTB_AUTHTYPE: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' AT_NAME varchar(30) ,';
...
function TFireBird.CreateTB_BARCODE: string;
var
  stSql : string;
begin
...
function TFireBird.CreateTB_KTBIZMEKADOOR: string;
var
  stSql : string;
begin
...
function TFireBird.CreateTB_KTBMDISPLAY: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' AC_ECUID varchar(2) NOT NULL,';
  stSql := stSql + ' DO_DOORNO varchar(1) NOT NULL,';
  stSql := stSql + ' KD_IP varchar(24) ,';
  stSql := stSql + ' KD_PORT varchar(10) ,';
  stSql := stSql + ' KD_CLEARTIME varchar(10) ,';
  stSql := stSql + ' KD_GENERALTIME varchar(10) ,';
  stSql := stSql + ' PRIMARY KEY (GROUP_CODE,AC_NODENO,AC_ECUID,DO_DOORNO) ';
  stSql := stSql + ' ) ';
...
function TFireBird.CreateTB_KTBMDISPLAYMESSAGE: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' KM_MESSAGE varchar(50) ,';
...
function TFireBird.CreateTB_SOUNDCODE: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' SO_NAME varchar(30) ,';
