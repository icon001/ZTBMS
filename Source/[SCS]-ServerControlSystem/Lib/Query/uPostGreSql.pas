...
function TPostGreSql.AlterTB_ACCESSEVENTAUTHTYPE: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSEVENT ADD AC_AUTHTYPE varchar(3) DEFAULT ''000'' NULL ';
  result := stSql;
end;
...
function TPostGreSql.AlterTB_ACCESSEVENTSCSHIS: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSEVENT ADD AC_SCSHIS varchar(5) NULL ';
  result := stSql;
...
function TPostGreSql.AlterTB_DoorSoundIP: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DOOR ADD DO_SOUNDIP varchar(30) NULL ';
  result := stSql;

end;

function TPostGreSql.AlterTB_DoorSoundPort: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DOOR ADD DO_SOUNDPORT varchar(30) NULL ';
  result := stSql;

end;

function TPostGreSql.AlterTB_DoorSoundVolume: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DOOR ADD DO_SOUNDVOLUME varchar(30) NULL ';
  result := stSql;
...
function TPostGreSql.CreateSEAT_USER_VIEW: string;
var
  stSql : string;
begin
  stSql := 'Create Table SEAT_USER_VIEW (';
  stSql := stSql + ' PID varchar(30) NOT NULL,';
  stSql := stSql + ' USERNAME varchar(30) ,';
  stSql := stSql + ' USERPWD varchar(20) ,';
  stSql := stSql + ' PAT_TYPE_DESC varchar(30) ,';
  stSql := stSql + ' PAT_TYPE int ,';
  stSql := stSql + ' DEPT_NAME varchar(30) ,';
  stSql := stSql + ' DEPT_CODE varchar(30) ,';
  stSql := stSql + ' CARD_ISSUE_CNT int ,';
  stSql := stSql + ' BEGIN_DATE varchar(8) ,';
  stSql := stSql + ' END_DATE varchar(8) ,';
  stSql := stSql + ' DATE_EXPRD varchar(8) ,';
  stSql := stSql + ' LOGN_OVER int ,';
  stSql := stSql + ' LAST_USEDATE varchar(8) ,';
...
function TPostGreSql.CreateTB_AUTHTYPE: string;
var
  stSql : string;
begin
  stSql := 'Create Table TB_AUTHTYPE (';
  stSql := stSql + ' GROUP_CODE varchar(10) DEFAULT ''1234567890'' NOT NULL,';
  stSql := stSql + ' AT_CODE varchar(3) NOT NULL,';
  stSql := stSql + ' AT_NAME varchar(30) NULL,';
...
function TPostGreSql.CreateTB_BARCODE: string;
var
  stSql : string;
begin
  stSql := 'Create Table TB_BARCODE (';
  stSql := stSql + ' GROUP_CODE varchar(10) DEFAULT ''1234567890'' NOT NULL,';
  stSql := stSql + ' BC_IP varchar(30) NOT NULL,';
  stSql := stSql + ' BC_PORT varchar(30) NOT NULL,';
  stSql := stSql + ' AC_NODENO Integer NULL,';
  stSql := stSql + ' AC_ECUID varchar(2) NULL,';
  stSql := stSql + ' DO_DOORNO char(1) NULL,';
  stSql := stSql + ' DO_READER char(1) NULL,';
...
function TPostGreSql.CreateTB_KTBIZMEKADOOR: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' AC_ECUID VARCHAR(2) NOT NULL,';
  stSql := stSql + ' DO_DOORNO VARCHAR(1) NOT NULL,';
  stSql := stSql + ' KD_DOORNO VARCHAR(10) NOT NULL,';
...
function TPostGreSql.CreateTB_KTBMDISPLAY: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' AC_ECUID varchar(2) NOT NULL,';
  stSql := stSql + ' DO_DOORNO varchar(1) NOT NULL,';
  stSql := stSql + ' KD_IP varchar(24) NULL,';
  stSql := stSql + ' KD_PORT varchar(10) NULL,';
  stSql := stSql + ' KD_CLEARTIME varchar(10) NULL,';
  stSql := stSql + ' KD_GENERALTIME varchar(10) NULL,';
  stSql := stSql + ' PRIMARY KEY (GROUP_CODE,AC_NODENO,AC_ECUID,DO_DOORNO) ';
  stSql := stSql + ' ) ';
...
function TPostGreSql.CreateTB_KTBMDISPLAYMESSAGE: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' AC_ECUID varchar(2) NOT NULL,';
  stSql := stSql + ' DO_DOORNO varchar(1) NOT NULL,';
  stSql := stSql + ' KM_CODE varchar(10) NOT NULL,';
  stSql := stSql + ' KM_MESSAGE varchar(50) NULL,';
...
function TPostGreSql.CreateTB_SOUNDCODE: string;
var
  stSql : string;
begin
  stSql := 'Create Table TB_SOUNDCODE (';
  stSql := stSql + ' GROUP_CODE varchar(10) DEFAULT ''1234567890'' NOT NULL,';
  stSql := stSql + ' SO_CODE char(1) NOT NULL,';
  stSql := stSql + ' SO_NAME varchar(30) NULL,';
...
function TPostGreSql.SelectTB_ATEVENTFromDayBase(aDate: string): string;
var
  stSql : string;
begin
...
function TPostGreSql.SelectTB_CARDJoinTBEmployee(aPrimary:string): string;
var
  stSql : string;
begin
